...
; 按 F4 回到倉庫第一頁
; 按 F2 將物品放到倉庫
;   第一次使用前請先按 F4 進行重設避免出問題
;   如果有發現物品放錯倉庫頁的問題，按 F4 後再試一次
; 按 F5 從城鎮進入藏身處
; 按 F6 暫離模式
; 按 F7 修正錯位
; 按 F12 顯示快截鍵列表
...
;============================== 物品辨識 ==============================
global Currencies := ["磨刀石", "知識卷軸", "混沌石", "護甲片", "卡蘭德的魔鏡", "點金石", "機會石", "後悔石", "蛻變石", "改造石", "重鑄石", "崇高石", "富豪石", "增幅石", "傳送卷軸", "玻璃彈珠", "寶石匠的稜鏡", "幻色石", "鏈結石", "工匠石", "神聖石", "祝福石", "製圖釘", "卷軸碎片", "瓦爾寶珠", "普蘭德斯金幣", "銀幣", "遺忘的污染器皿", "製圖六分儀", "無效石", "束縛石", "地平石", "神諭石", "工程石", "古變石", "魔鏡碎片", "幻像斷片", "之譫妄玉"]
